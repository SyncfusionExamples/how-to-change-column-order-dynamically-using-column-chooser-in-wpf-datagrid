...
The [ColumnChooser](https://help.syncfusion.com/wpf/datagrid/interactive-features#%22columnchooser%22) [allows you to add or remove columns dynamically from the current view of grid by drag-and-drop operations in](https://help.syncfusion.com/wpf/datagrid/interactive-features#columnchooser) [WPF DataGrid](https://www.syncfusion.com/wpf-controls/datagrid) (SfDataGrid). You can change the column order dynamically through column chooser by using the [BaseCommand](https://help.syncfusion.com/cr/wpf/Syncfusion.html) class as shown in the below code snippet,
